...
namespace OLIVER\MonExtension\Tests\Unit\Domain\Model;
...
/**
 * Test case for class \OLIVER\MonExtension\Domain\Model\Commentaire.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class CommentaireTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \OLIVER\MonExtension\Domain\Model\Commentaire
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \OLIVER\MonExtension\Domain\Model\Commentaire();
	}
