 ...
 *
 */
class TitreTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \OLIVER\MonExtension\Domain\Model\Titre
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \OLIVER\MonExtension\Domain\Model\Titre();
	}
